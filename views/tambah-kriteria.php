...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $query = "INSERT INTO kriteria (nama_kriteria, bobot_kriteria) VALUES ('$nama_kriteria', '$bobot_kriteria')";
                ...
                <div class="content-view">
                    <div class="card">
                        ...
                        <div class="card-block">
                            ...
                            <?php endif; ?>
                            <form method="POST" action="tambah-kriteria.php">
